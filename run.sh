#sh run.sh icu.txt A B A B niche ../
#lefse
...
python ${7}extract_features_from_mrmr.py -i ${2}_biomarker_mrmr.txt ${3}_biomarker_mrmr.txt -t ${2}_biomarker.csv ${3}_biomarker.csv 
#mei
rm test.txt train.txt
python ${7}divide28.py -f mrmr_features_abd.txt -g $4 -a $5
python ${7}me_h_i_model.py -f train.txt -t test.txt -g $4
#plot
Rscript ${7}plot_roc.R -m test_mei_list_for_roc_r.txt -f mrmr_features_abd.txt -n ${6}
